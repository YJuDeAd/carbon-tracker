  ...
  return (
    <div className="flex flex-col min-h-screen bg-background p-4">
      ...
      <Tabs defaultValue="transport" className="w-full">
        ...
        {/* Empty states for other tabs for MVP demonstration */}
        {["food", "energy", "shopping", "travel"].map((category) => (
          <TabsContent key={category} value={category} className="mt-6 text-center text-muted-foreground py-12">
            Select an activity to log your {category} emissions.
          </TabsContent>
        ))}
      </Tabs>
    </div>
